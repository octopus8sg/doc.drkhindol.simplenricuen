 ...
 */
class CRM_Simplenricuen_Upgrader_Base {

  /**
   * @var CRM_Simplenricuen_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Simplenricuen_Upgrader(
        'com.drkhindol.simplenricuen',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Simplenricuen_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Simplenricuen_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
